      ...
      <main className="flex-grow pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-8 pt-8">
            <Link to="/events" className="inline-flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-indigo-600 transition-colors font-bold group">
              <div className="w-8 h-8 rounded-full bg-white dark:bg-[#12092a] transition-colors duration-300 border border-slate-200 dark:border-slate-700 flex items-center justify-center group-hover:border-indigo-200 group-hover:bg-indigo-50 transition-all">
                <ArrowLeft size={16} />
              </div>
              Back to Events
            </Link>
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              >
                ...
                <div className="absolute top-8 left-8">
                  <span className="px-6 py-2.5 bg-white dark:bg-[#12092a] transition-colors duration-300/95 backdrop-blur-md text-indigo-600 font-black text-xs tracking-widest rounded-2xl shadow-xl uppercase">
                    {eventData.category}
                  </span>
                </div>
              </motion.div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-6 text-slate-600 dark:text-slate-300">
                  <div className="flex items-center gap-3 bg-white dark:bg-[#12092a] transition-colors duration-300 px-5 py-3 rounded-2xl border border-slate-100 dark:border-slate-800/60 shadow-sm dark:shadow-none">
              ...
              <div className="bg-white dark:bg-[#12092a] transition-colors duration-300 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800/60 shadow-sm dark:shadow-none space-y-6">
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">About the Event</h2>
                <div className="prose prose-slate max-w-none text-slate-500 dark:text-slate-400 leading-relaxed text-lg whitespace-pre-line">
            ...
            <div className="lg:col-span-4 space-y-8">
              <div className="sticky top-32">
                <motion.div 
                  ...
                  className="bg-white dark:bg-[#12092a] transition-colors duration-300 rounded-[2.5rem] p-10 border border-slate-100 dark:border-slate-800/60 shadow-2xl shadow-indigo-100/50"
                >
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <div className="text-slate-400 text-xs font-bold uppercase tracking-widest mb-1">Registration Fees</div>
                      <div className="text-4xl font-black text-slate-900 dark:text-white">{price}</div>
                    </div>
                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-8 mt-8 text-white relative overflow-hidden group">
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    <div className="w-12 h-12 bg-white dark:bg-[#12092a] transition-colors duration-300/10 rounded-xl flex items-center justify-center">
                      <Users size={24} />
                    </div>
                    <div>
        ...
        {showRegisterModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-[#12092a] transition-colors duration-300 w-full max-w-lg rounded-[3rem] shadow-2xl relative z-10 overflow-hidden"
            >
              <div className="p-10">
                <button onClick={() => setShowRegisterModal(false)} className="absolute top-8 right-8 text-slate-400 hover:text-slate-600 dark:text-slate-300">
                  <X size={24} />
                </button>
                ...
                {step === 1 && (
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Student Details</h2>
                      <p className="text-slate-500 dark:text-slate-400">Please provide your information to register.</p>
                    </div>
                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 no-scrollbar">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Full Name</label>
                          <input type="text" value={formData.fullName} onChange={(e) => setFormData({...formData, fullName: e.target.value})} className="w-full px-5 py-3.5 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border border-slate-100 dark:border-slate-800/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold text-slate-700 dark:text-slate-200" placeholder="Your Name" />
                        </div>
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Roll Number</label>
                          <input type="text" value={formData.rollNo} onChange={(e) => setFormData({...formData, rollNo: e.target.value})} className="w-full px-5 py-3.5 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border border-slate-100 dark:border-slate-800/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold text-slate-700 dark:text-slate-200" placeholder="e.g. 2K23CSUN0000" />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Email Address</label>
                        <input type="email" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} className="w-full px-5 py-3.5 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border border-slate-100 dark:border-slate-800/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold text-slate-700 dark:text-slate-200" placeholder="Your Email" />
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Branch</label>
                          <input type="text" value={formData.branch} onChange={(e) => setFormData({...formData, branch: e.target.value})} className="w-full px-5 py-3.5 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border border-slate-100 dark:border-slate-800/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold text-slate-700 dark:text-slate-200" placeholder="e.g. CSE" />
                        </div>
                        <div className="space-y-1.5">
                          <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Semester</label>
                          <input type="text" value={formData.semester} onChange={(e) => setFormData({...formData, semester: e.target.value})} className="w-full px-5 py-3.5 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border border-slate-100 dark:border-slate-800/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold text-slate-700 dark:text-slate-200" placeholder="e.g. 4" />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Phone Number</label>
                        <input type="tel" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} className="w-full px-5 py-3.5 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border border-slate-100 dark:border-slate-800/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 font-bold text-slate-700 dark:text-slate-200" placeholder="+91 XXXXX XXXXX" />
                      </div>
                    </div>
                ...
                {step === 2 && (
                  <div className="space-y-8">
                    <div className="text-center">
                      ...
                      <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Review Fees</h2>
                      <p className="text-slate-500 dark:text-slate-400">Check your details before proceeding.</p>
                    </div>
                    <div className="bg-slate-50 dark:bg-[#050014] transition-colors duration-300 p-6 rounded-3xl space-y-4">
                      <div className="flex justify-between text-sm"><span className="text-slate-500 dark:text-slate-400 font-medium">Attendee</span><span className="text-slate-900 dark:text-white font-bold">{formData.fullName}</span></div>
                      <div className="flex justify-between text-sm"><span className="text-slate-500 dark:text-slate-400 font-medium">ID / Roll No</span><span className="text-slate-900 dark:text-white font-bold">{formData.rollNo}</span></div>
                      <div className="flex justify-between text-sm"><span className="text-slate-500 dark:text-slate-400 font-medium">Branch</span><span className="text-slate-900 dark:text-white font-bold">{formData.branch} - Sem {formData.semester}</span></div>
                      <div className="border-t border-slate-200 dark:border-slate-700 pt-4 flex justify-between">
                        <span className="text-slate-900 dark:text-white font-bold">Registration Fees</span>
                        <span className="text-indigo-600 font-black text-xl">{price}</span>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <button onClick={() => setStep(1)} className="flex-grow py-5 bg-white dark:bg-[#12092a] transition-colors duration-300 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-black rounded-2xl">Edit Details</button>
                ...
                {step === 3 && (
                  <div className="space-y-8">
                    <div className="text-center">
                      ...
                      <p className="text-slate-500 dark:text-slate-400">Scan the QR code below to pay <span className="font-bold text-violet-600">{price}</span></p>
                    </div>
                    <div className="bg-white dark:bg-[#12092a] transition-colors duration-300 p-6 rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-800/60 flex justify-center shadow-inner">
                      <div className="w-48 h-48 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 rounded-2xl flex items-center justify-center border border-dashed border-slate-300">
                    ...
                    <div className="space-y-4">
                      <label className="block text-sm font-bold text-slate-700 dark:text-slate-200 ml-1">Upload Payment Screenshot</label>
                      <div className="relative group">
                        <input type="file" onChange={handleFileChange} className="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" />
                        <div className="w-full p-6 bg-slate-50 dark:bg-[#050014] transition-colors duration-300 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl text-center group-hover:border-violet-300 transition-colors">
                          <Upload className="mx-auto text-slate-400 mb-2" size={24} />
                          <div className="text-sm font-bold text-slate-600 dark:text-slate-300">{screenshot ? screenshot.name : 'Choose a file or drag it here'}</div>
                          <div className="text-xs text-slate-400 mt-1">JPEG, PNG up to 5MB</div>
                        </div>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <button onClick={() => setStep(2)} className="flex-grow py-5 bg-white dark:bg-[#12092a] transition-colors duration-300 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-black rounded-2xl">Back</button>
                ...
                {step === 4 && (
                  <div className="space-y-8 py-10">
                    <div className="text-center">
                      ...
                      <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">Registration Sent!</h2>
                    ...
                    <div className="flex gap-4">
                      ...
                      <button onClick={() => setShowRegisterModal(false)} className="flex-grow py-5 bg-white dark:bg-[#12092a] transition-colors duration-300 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 font-black rounded-2xl">Dismiss</button>
                    </div>
                  </div>
                )}
              </div>
